...
<script lang="ts" name="content-tree" setup>
...
async function refresh() {
	...
	await service.cms.contentType.list().then((res) => {
...
function rowEdit(item: any) {
	...
	Form.value?.open({
		...
		on: {
			open() {
				service.cms.model.list().then((res) => {
			...
			submit(data, { done, close }) {
				service.cms.contentType[method]({
					id: item.id,
...
function onContextMenu(e: any, d?: any, n?: any) {
	...
	// 权限
	const perm = service.cms.contentType.permission;
